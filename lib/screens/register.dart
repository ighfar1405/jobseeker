                  ...
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          onChanged: (deskripsiAkun) => context
                              .read<RegistrationBloc>()
                              .add(DeskripsiAkunChanged(deskripsiAkun)),
                          controller: _deskripsiAkunController,
                          decoration: InputDecoration(
                              contentPadding: EdgeInsets.symmetric(
                                  vertical: 10, horizontal: 15),
                              filled: true,
                        ...
                        TextField(
                          onChanged: (alamat) => context
                              .read<RegistrationBloc>()
                              .add(AlamatChanged(alamat)),
                        ...
                        TextField(
                          onChanged: (confirmationPassword) => context
                              .read<RegistrationBloc>()
                              .add(ConfirmationPasswordChanged(
